...
print(f"The area of the garden is {area}")
print(f"The circumference of the garden is {circumference}")
print(f"The square of the garden is {square_root}")
print(f"The rounded down area of the garden is {floor_area}")
print(f"The rounded up area of the garden is {ceil_area}")